...
?>
<?if (count($SECTIONS) > 1):?>
	<ul class="nav nav-pills justify-content-center justify-content-md-between" id="programms-tab" role="tablist">
...
<?$APPLICATION->IncludeComponent("bitrix:news.list", "directions", Array(
