	...
	<div class="swiper-wrapper pt-md-5">
		...
		?>
			<div class="swiper-slide">
				<a href="#" class="team-item d-block text-center position-relative" data-bs-toggle="modal" data-bs-target="#team-<?= $arItem['ID'] ?>">
...
<div class="swiper__control team_swiper__control d-flex align-items-center gap-4">
				...
				<div class="modal-body p-0">
					<div class="row">
						<div class="col-12 col-lg-6 position-relative d-none d-lg-block">
							...
							<?if ($arItem["DETAIL_TEXT"] && strip_tags($arItem["DETAIL_TEXT"]) != '«Тут можно написать приветствие от тренера или любую цитату от него»'):?>
						...
						<div class="col-12 col-lg-6">
							<div class="modal__box-content h-100 d-flex flex-column p-2 p-md-5">
								<div class="flex-shrink-1">
									<div class="fs-24 fw-700 mb-4"><?= $arItem["NAME"] ?></div>
									<?if ($arItem['PROPERTIES']['POST']['VALUE']):?>
									<p class="text-info"><?=implode(', ', $arItem['PROPERTIES']['POST']['VALUE']);?></p>
									<?endif;?>
								</div>
								<div class="h-100 position-relative">
									<div class="modal__numbered-list fs-16 lh-13 text-info h-100 overflow-auto">
