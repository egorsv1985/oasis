				...
				<div class="col-12 col-lg-8">
					<? $APPLICATION->IncludeComponent(
						...
						array(
							...
							"DETAIL_PROPERTY_CODE" => array(0 => "TIME", 1 => "DATE", 2 => "location", 3 => "TYPE", 4 => "LOCATION",),
							...
							"LIST_PROPERTY_CODE" => array(0 => "TIME", 1 => "DATE", 2 => "location", 3 => "TYPE", 4 => "LOCATION",),
							"MESSAGE_404" => "",
							"META_DESCRIPTION" => "-",
							"META_KEYWORDS" => "-",
							"NEWS_COUNT" => "200",
