...
?>
<div class="form-contaner rounded-5 p-4">
	...
	<div class="row gy-2 align-items-center">
		<?if (is_array($arResult["PROPERTY_LIST"]) && !empty($arResult["PROPERTY_LIST"])):?>
			<?foreach ($arResult["PROPERTY_LIST"] as $propertyID):
				...
				if(in_array($propertyID, $arResult["PROPERTY_REQUIRED"])) $PLACEHOLDER .= ' *';
				...
				<div class="col-12 col-md">
						...
						<textarea cols="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["COL_COUNT"]?>" rows="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["ROW_COUNT"]?>" name="PROPERTY[<?=$propertyID?>][<?=$i?>]"><?=$value?></textarea>
							...
							case "N":
								...
								<input class="form-control" type="text" name="PROPERTY[<?=$propertyID?>][<?=$i?>]" size="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["COL_COUNT"]; ?>" value="<?=$value?>" placeholder="<?=$PLACEHOLDER;?>"/><?
		...
		<?endif?>
		<div class="col-md-2">
					<input type="submit" name="iblock_submit" class="btn btn-green w-100" value="Отправить" />
