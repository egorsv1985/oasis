			...
			<div class="row mb-4 gy-4">
				...
				<div class="col-12 col-md-4 offset-xl-1 order-2 order-md-0">
					<ul class="contacts__list mb-4">
						<li><a href="#" target="_blank">Способы оплаты</a></li>
						<li><a href="#" target="_blank">Правила клуба</a></li>
						<li><a href="#" target="_blank">Политика конфиденциальности</a></li>
						<li><a href="#" target="_blank">Разработка сайта: ТКК</a></li>
						<li><a href="https://cheporeklame.tilda.ws/" target="_blank">Маркетинг : #ЧЁПОРЕКЛАМЕ</a></li>
					</ul>
