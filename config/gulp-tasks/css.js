...
// //     );
// // }
// import merge from "merge-stream"; // Добавьте этот импорт в начале файла
...
//   return merge(cssStream, minCssStream);
// };
...
export const css = () => {
  const cssStream = app.gulp.src(`${app.path.build.css}style.css`, {})
    .pipe(app.plugins.plumber(
      app.plugins.notify.onError({
        title: "CSS",
        message: "Error: <%= error.message %>"
